...
extern "C" void initTrish256(void);
extern "C" void init_NUG_256(void);

extern "C" void closeHistogram64(void);
extern "C" void closeHistogram256(void);
extern "C" void closeTrish256(void);
extern "C" void close_NUG_256(void);
...
extern "C" void histogramTrish256(
	uint *d_Histogram,
	void *d_Data,
	uint byteCount
);

extern "C" void histogram_NUG_256(
	uint *d_Histogram,
	void *d_Data,
	uint byteCount
);
